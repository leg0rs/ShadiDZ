/* 
данный интерфейс был написан с помощью https://transform.tools/json-to-typescript,
так как я бы рехнулся ручками писать 2000 строк однообразного интерфейса, прошу понять меня
и не судить строго

И чего-то сверх естественого, что я бы не смог написать тут нет, так как 90+ процентов 
это названия языка comon + official, поэтому я решил не писать их все ручками
*/
